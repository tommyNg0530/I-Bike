...
{	
	 ...
	 */
	uint16_t max_column = 239;
	uint16_t max_page = 319;
	LCD_OpenWindow(usCOLUMN, usPAGE, max_column-usCOLUMN, max_page-usPAGE);
...
{	
	...
	//I reference to the mid-point ellipse algorithm
